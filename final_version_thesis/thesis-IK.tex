...
\label{sec:link_github}
All data, notebooks and python scripts that are used for the analysis in this thesis is available in a public GitHub repository using the following link: 
\url{https://github.com/anyakiewit/bachelor_thesis}
