"""
ModernBERT - Multi-label Frame Classification
Fine-tunes answerdotai/ModernBERT-base on the golden standard dataset.
A more efficient and capable successor to BERT with longer context support.
