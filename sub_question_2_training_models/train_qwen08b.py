"""
Qwen3.5-0.8B - Multi-label Frame Classification
Fine-tunes Qwen/Qwen3.5-0.8B as a sequence classifier on the golden standard dataset.
The smallest model in the comparison to test how size reduction affects accuracy.
...
OUTPUT_DIR = "./qwen08b_checkpoints"
MAX_LENGTH = 1024
BATCH_SIZE = 1           
GRAD_ACCUM = 16           
LEARNING_RATE = 4e-5
...
# Qwen models use EOS token as padding token
...
_cfg.pad_token_id = tokenizer.pad_token_id
model = AutoModelForSequenceClassification.from_pretrained(MODEL_NAME, config=_cfg)
